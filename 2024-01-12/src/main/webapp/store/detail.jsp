                    ...
                    <p class="mb-4">
               		...
               		<c:if test="${sessionScope.id!=null }">
						...
						<c:if test="${jjim_count==0 }">
							<a href="#" id="jjimButton" class="btn btn-xs btn-danger">찜하기</a>
						</c:if>
						<c:if test="${jjim_count!=0 }">
									...
									<td class="text-right">
										<c:if test="${rvo.id==sessionScope.id }">
											...
											<form method="post" action="../reply/delete.do" style="float: left;margin-left: 2px">
							                	...
							                	<input type="hidden" name="cno" value="${vo.gno }">
 								...
 								<tr style="display: none" id="u${rvo.no }" class="ups">
							    	<td>
							        	<form method="post" action="../reply/update.do">
							         		...
							         		<input type="submit" value="댓글수정" style="float: left;width: 95px;height: 103px;text-align: center;margin-left: 2px" class="btn-primary">
							        	</form>
							    	</td>
							    </tr>
							</table>
